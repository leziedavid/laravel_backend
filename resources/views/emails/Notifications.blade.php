                     ...
                     <div class="row">
                            <div class="col-12">
                                ...
                                @if($maildata['state']== 1)
                                    ...
                                    @elseif($maildata['state'] == 4)

                                    <h5 class="mb-4">{{$maildata['hello']}},</h5>

                                    <p class="mb-2">{{$maildata['message']}}</p>

                                    <p class="mb-2">{{$maildata['Devis']}}</p>

                                    <p class="mb-2">{{$maildata['pub']}}</p>
                                    </br>
                                    <a href="{{$maildata['url']}}" type="button" class="btn btn-primary">Télécharger le fichier joints ...</a>
